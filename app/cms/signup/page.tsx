    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-black via-gray-900 to-black">
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-400">Create your CMS account</p>
        </div>
        ...
        <Card className="cms-card border-white/10">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-gray-400">Create an account to access the CMS</CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <div className="mt-6 text-center">
              <p className="text-gray-400 text-sm">
                ...
                <Link href="/cms/login" className="text-violet-400 hover:text-violet-300 font-medium">
                  Sign in
                </Link>
              </p>
            </div>
